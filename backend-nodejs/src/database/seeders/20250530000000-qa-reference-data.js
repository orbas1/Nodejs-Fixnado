  ...
  await queryInterface.bulkInsert('CommunicationsQuickReply', [
    {
      ...
      configuration_id: COMMUNICATION_CONFIG_ID,
      title: 'Welcome new crews',
      body: 'Thanks for joining Fixnado Hub! Review the go-live checklist pinned in #timeline-upgrades.',
      category: 'onboarding',
      sort_order: 1,
  ...
  await queryInterface.bulkInsert('CommunicationsEscalationRule', [
    {
      ...
      description: 'Escalate VIP client reports when the timeline feed is degraded.',
