export const Permissions = Object.freeze({
  ...
  PROVIDER_DISPUTE_MANAGE: 'provider:disputes:manage',
  ...
  PROVIDER_CREW_VIEW: 'provider:crew:view',
  PROVIDER_CREW_MANAGE: 'provider:crew:manage',
  PROVIDER_CREW_SCHEDULE: 'provider:crew:schedule',
  ...
  SERVICEMAN_CUSTOM_JOBS_READ: 'serviceman:custom-jobs:read',
  SERVICEMAN_CUSTOM_JOBS_WRITE: 'serviceman:custom-jobs:write',
