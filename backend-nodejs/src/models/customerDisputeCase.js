...
class CustomerDisputeCase extends Model {}

CustomerDisputeCase.init(
  {
    id: {
      type: DataTypes.UUID,
    ...
    title: encryptedAttribute('title', 'customerDisputeCase:title', 'title_encrypted', { allowNull: false }),
    category: {
    ...
    summary: encryptedAttribute('summary', 'customerDisputeCase:summary', 'summary_encrypted'),
    nextStep: encryptedAttribute('nextStep', 'customerDisputeCase:nextStep', 'next_step_encrypted'),
    assignedTeam: encryptedAttribute('assignedTeam', 'customerDisputeCase:assignedTeam', 'assigned_team_encrypted'),
    assignedOwner: encryptedAttribute('assignedOwner', 'customerDisputeCase:assignedOwner', 'assigned_owner_encrypted'),
    resolutionNotes: encryptedAttribute(
      'resolutionNotes',
      'customerDisputeCase:resolutionNotes',
      'resolution_notes_encrypted'
    ),
    externalReference: encryptedAttribute(
      'externalReference',
      'customerDisputeCase:externalReference',
  ...
  {
    sequelize,
    modelName: 'CustomerDisputeCase',
    tableName: 'customer_dispute_cases',
    underscored: true
  }
);

export default CustomerDisputeCase;
