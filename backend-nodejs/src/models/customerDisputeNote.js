...
class CustomerDisputeNote extends Model {}

CustomerDisputeNote.init(
  {
    id: {
      type: DataTypes.UUID,
    ...
    body: encryptedAttribute('body', 'customerDisputeNote:body', 'body_encrypted', { allowNull: false }),
    nextSteps: encryptedAttribute('nextSteps', 'customerDisputeNote:nextSteps', 'next_steps_encrypted'),
    pinned: {
  ...
  {
    sequelize,
    modelName: 'CustomerDisputeNote',
    tableName: 'customer_dispute_notes',
    underscored: true
  }
);

export default CustomerDisputeNote;
