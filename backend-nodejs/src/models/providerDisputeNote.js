...
class ProviderDisputeNote extends Model {}

ProviderDisputeNote.init(
  {
    id: {
      type: DataTypes.UUID,
    ...
    body: encryptedAttribute('body', 'providerDisputeNote:body', 'body_encrypted', { allowNull: false }),
    nextSteps: encryptedAttribute('nextSteps', 'providerDisputeNote:nextSteps', 'next_steps_encrypted'),
    pinned: {
  ...
  {
    sequelize,
    modelName: 'ProviderDisputeNote',
    tableName: 'provider_dispute_notes',
    underscored: true
  }
);

export default ProviderDisputeNote;
