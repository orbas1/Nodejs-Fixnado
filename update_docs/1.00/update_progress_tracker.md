...
| Task 4 — Cross-Channel Experience & Collaboration | 42 | 38 | 34 | 33 | 32 | 30 | 35 | React explorer is live with MapLibre zoning, demand-aware filtering, and SLA insights (`frontend-reactjs/src/pages/Search.jsx`, `components/explorer/*`). API client + utilities normalise zone geometry across SQLite/PostGIS, Vitest coverage enforces deterministic filtering, and programme/design change logs now capture the explorer rollout. Flutter parity, booking wizard, and comms stack remain in backlog. |
