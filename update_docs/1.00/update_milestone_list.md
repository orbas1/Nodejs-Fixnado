...
| **DM4 — Validation & Compliance Gate Passed** | Accessibility, security, and QA sign-offs complete; handoff packages distributed to engineering. | Week 6 | DM1–DM3, legal/compliance approvals, QA readiness. |
