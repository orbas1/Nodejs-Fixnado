...
- **Governance Extension (2025-10-14):** CI Quality Gates workflow publishes coverage artefacts and rollback procedures, enabling Design Ops to validate telemetry/issue-intake governance before approving blueprints or pilot rollouts.
- **Subtasks:**
