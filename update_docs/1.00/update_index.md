...
- [`change_log.md`](change_log.md) — Logged CI Quality Gates workflow, coverage thresholds, rollback playbook, and tracker updates closing Task 1.3.
- [`build_updates.md`](build_updates.md) — Captured CI Quality Gates workflow, Vitest threshold tuning, and rollback playbook publication.
- [`task1_ci_cd_pipeline_extension.md`](task1_ci_cd_pipeline_extension.md) — Delivery dossier for Subtask 1.3 covering workflow architecture, coverage enforcement, security scans, and rollback governance.
- [`docs/ops/ci-rollback-playbook.md`](../docs/ops/ci-rollback-playbook.md) — New operational runbook outlining backend, React, Flutter, and governance rollback procedures.
- [`update_task_list.md`](update_task_list.md), [`update_progress_tracker.md`](update_progress_tracker.md), [`update_milestone_list.md`](update_milestone_list.md) — Raised Task 1 maturity to reflect CI Quality Gates completion and outlined Task 1.5 follow-ups.
- [`backend-nodejs/vitest.config.js`](../backend-nodejs/vitest.config.js), [`frontend-reactjs/vitest.config.js`](../frontend-reactjs/vitest.config.js), [`backend-nodejs/package.json`](../backend-nodejs/package.json), [`frontend-reactjs/package.json`](../frontend-reactjs/package.json) — Coverage scope + thresholds enforced for CI gating.
- [`Design_Change_log.md`](Design_Change_log.md), [`Design_Plan.md`](Design_Plan.md), [`Design_update_task_list.md`](Design_update_task_list.md), [`Design_update_progress_tracker.md`](Design_update_progress_tracker.md), [`Design_update_milestone_list.md`](Design_update_milestone_list.md) — Documented design governance alignment with CI Quality Gates alerts and evidence capture.
- [`frontend_updates/change_log.md`](frontend_updates/change_log.md), [`backend_updates/backend_change_log.md`](backend_updates/backend_change_log.md), [`user_phone_app_updates/user_app_change_log.md`](user_phone_app_updates/user_app_change_log.md) — Recorded coverage enforcement and rollback guidance across stacks.
